...
<%@include file="/WEB-INF/views/navbar.jsp"%>
				...
				<form:form action="${pageContext.request.contextPath}/admin/item/editItems" 
                   ...
                   <div class="span9 center margin-bottom"> 
					...
					<div class="control-group">
						...
						<div class="control-group">
					  	<label class="control-label">Category</label><form:errors path="category" cssStyle="color: #ff0000;" />
						<div class="controls docs-input-sizes">
		   				<form:select path="category">
    						<form:option value="" label="----Please Select------" />
    						<form:options path="category.name" items="${categoryList}" itemValue="name" itemLabel="name"  />
	     					</form:select>
						</div>
		   			  	</div>
